...
Units::Length HfpReaderPre2020::GetX() { return Units::MetersLength(GetDouble(m_x_column)); }

Units::Length HfpReaderPre2020::GetY() { return Units::MetersLength(GetDouble(m_y_column)); }

Units::Length HfpReaderPre2020::GetDTG() { return Units::MetersLength(GetDouble(m_dtg_column)); }

std::string HfpReaderPre2020::GetSegmentType() { return GetString(m_segment_type_column); }

Units::Angle HfpReaderPre2020::GetCourse() { return Units::RadiansAngle(GetDouble(m_course_column)); }

Units::Length HfpReaderPre2020::GetTurnCenterX() { return Units::MetersLength(GetDouble(m_turn_center_x_column)); }

Units::Length HfpReaderPre2020::GetTurnCenterY() { return Units::MetersLength(GetDouble(m_turn_center_y_column)); }
...
Units::Angle HfpReaderPre2020::GetBankAngle() { return Units::DegreesAngle(GetDouble(m_bank_angle_column)); }

Units::Angle HfpReaderPre2020::GetLatitude() { return Units::DegreesAngle(GetDouble(m_latitude_column)); }

Units::Angle HfpReaderPre2020::GetLongitude() { return Units::DegreesAngle(GetDouble(m_longitude_column)); }
