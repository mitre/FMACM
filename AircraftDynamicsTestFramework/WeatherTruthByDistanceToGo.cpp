...
WeatherTruthByDistanceToGo::WeatherTruthByDistanceToGo() : StandardAtmosphere(Units::zero()), m_weather() {
...
void WeatherTruthByDistanceToGo::LoadEnvFile(const string &env_csv_file) {
   ...
   while (!feof(env)) {
      ...
      if (strlen(line) > 6) {
         sscanf(line, "%lf,%lf,%lf,%lf,%lf,%lf,%lf", &time, &distToGo, &Vwx, &Vwy, &dVwx_dh, &dVwy_dh, &temperature);
         m_weather = new Weather();
...
/** Ignore parameters, return temp from set weather */
Units::KelvinTemperature WeatherTruthByDistanceToGo::InterpolateTemperature(const Units::Angle latitude_in,
...
/** Ignore parameters, return temp from set weather */
Units::Pressure WeatherTruthByDistanceToGo::InterpolatePressure(const Units::Angle latitude_in,
                                                                const Units::Angle longitude_in,
                                                                const Units::Length altitude) {
...
void WeatherTruthByDistanceToGo::InterpolateWind(Units::Angle latitude_in, Units::Angle longitude_in,
                                                 Units::Length altitude, Units::Speed &u, Units::Speed &v) {
   u = m_weather->Vwx;
   v = m_weather->Vwy;
}

/** Ignore parameters, return wind components from set weather */
void WeatherTruthByDistanceToGo::InterpolateWindScalar(Units::Angle lat_in, Units::Angle lon_in, Units::Length altitude,
...
void WeatherTruthByDistanceToGo::InterpolateWindMatrix(Units::Angle lat_in, Units::Angle lon_in, Units::Length alt_in,
...
std::shared_ptr<WeatherTruthByDistanceToGo> WeatherTruthByDistanceToGo::GetSharedPtr() const { return m_shared_ptr; }
