...
WeatherTruthByTime::WeatherTruthByTime() : StandardAtmosphere(Units::zero()), m_weather() {
...
/** Ignore parameters, return temp from set weather */
Units::KelvinTemperature WeatherTruthByTime::InterpolateTemperature(const Units::Angle latitude_in,
...
/** Ignore parameters, return temp from set weather */
Units::Pressure WeatherTruthByTime::InterpolatePressure(const Units::Angle latitude_in, const Units::Angle longitude_in,
                                                        const Units::Length altitude) {
...
void WeatherTruthByTime::InterpolateWind(Units::Angle latitude_in, Units::Angle longitude_in, Units::Length altitude,
...
/** Ignore parameters, return wind components from set weather */
void WeatherTruthByTime::InterpolateWindScalar(Units::Angle lat_in, Units::Angle lon_in, Units::Length altitude,
...
void WeatherTruthByTime::InterpolateWindMatrix(Units::Angle lat_in, Units::Angle lon_in, Units::Length alt_in,
...
std::shared_ptr<WeatherTruthByTime> WeatherTruthByTime::GetSharedPtr() const { return m_shared_ptr; }
