...
public:
	...
	AircraftIntentFromFile(const AircraftIntentFromFile &in); // copy constructor for AircraftIntent
	AircraftIntentFromFile& operator=(const AircraftIntentFromFile &in); // assignment operator overload
...
private:
	...
	double localstod(string s);
	int localstoi(string s);
};
