...
public:
	...
	bool open_Archive(const string &new_file_name, const string &header_comment)
	{
	...
	void rewrite_Last_in_Archive(const string &s)
	{
	...
	//before it is closed
	void write_Last_Token(string old_token)
	{
		if(archive_file.is_open())
		{
