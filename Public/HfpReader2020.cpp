...
HfpReader2020::HfpReader2020(std::string file_name,
                             int header_lines)
...
HfpReader2020::HfpReader2020(std::shared_ptr<std::istream> input_stream,
                             int header_lines)
...
Units::Length HfpReader2020::GetX() {
   return Units::MetersLength(GetDouble(m_x_column));
}

Units::Length HfpReader2020::GetY() {
   return Units::MetersLength(GetDouble(m_y_column));
}

Units::Length HfpReader2020::GetDTG() {
...
Units::Angle HfpReader2020::GetCourse() {
   return Units::RadiansAngle(GetDouble(m_course_column));
}

Units::Length HfpReader2020::GetTurnCenterX() {
   return Units::MetersLength(GetDouble(m_turn_center_x_column));
}

Units::Length HfpReader2020::GetTurnCenterY() {
...
Units::Angle HfpReader2020::GetAngleEndOfTurn() {
