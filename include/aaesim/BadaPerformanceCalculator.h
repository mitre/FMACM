...
namespace aaesim {
   class BadaPerformanceCalculator : public Bada {
    public:
       ...
       */
      void GetDragCoefficients(const Units::Speed &calibrated_airspeed,     /** [in] Calibrated airspeed */
                            const Units::Length &altitude_msl,             /** [in] Altitude MSL */
                            const aaesim::open_source::bada_utils::FlapConfiguration &current_flap_configuration, /** [in] current flap configuration */
       ...
       */
      void GetDragCoefficientsAndIncrementFlapConfiguration(const Units::Speed &calibrated_airspeed, /** [in] Calibrated airspeed */
                                                            const Units::Length &altitude_msl,     /** [in] Altitude MSL */
                                                            double &cd0,        /** [out] parasitic drag coefficient */
                                                            double &cd2,        /** [out] induced drag coefficient */
                                                            double &gear,       /** [out] landing gear drag coefficient */
       ...
       */
      void GetConfigurationForIncreasedDrag(const Units::Speed &calibrated_airspeed, /** [in] Calibrated airspeed */
                                            const Units::Length &altitude_msl,     /** [in] Altitude MSL */
                                            aaesim::open_source::bada_utils::FlapConfiguration &updated_flap_setting /** [out] flap configuration */);
       ...
       */
      Units::NewtonsForce GetMaxThrust(const Units::Length &altitude_msl, /** [in] altitude_msl */
      ...
      void GetCoefficientsForFlapConfiguration(open_source::bada_utils::FlapConfiguration flap_configuration,
                                               double &cd0,
                                               double &cd2,
                                               double &gear) const;

      aaesim::open_source::bada_utils::FlapConfiguration GetFlapConfigurationForState(const Units::Speed &calibrated_airspeed,
      ...
      FlapSpeeds GetFlapSpeeds() const;
    ...
    private:
      ...
      open_source::bada_utils::FlapConfiguration PerformReverseFlapProgression(open_source::bada_utils::FlapConfiguration current_flap_configuration, Units::Speed calibrated_airspeed, const bool near_final_approach_fix) const;
      open_source::bada_utils::FlapConfiguration PerformNormalFlapProgression(open_source::bada_utils::FlapConfiguration current_flap_configuration, Units::Speed calibrated_airspeed, const bool near_final_approach_fix) const;

    protected:
      open_source::bada_utils::FlapConfiguration m_flap_configuration;
      FlapSpeeds m_flap_speeds;
   ...
   inline Units::Mass BadaPerformanceCalculator::GetAircraftMass() const {
      return m_aircraft_mass;
   }

   inline double BadaPerformanceCalculator::GetAircraftMassPercentile() const {
      return m_mass_percentile;
   }

   inline BadaPerformanceCalculator::FlapSpeeds BadaPerformanceCalculator::GetFlapSpeeds() const {
   ...
   inline Units::Length BadaPerformanceCalculator::GetAltitudeAtFaf() const {
      return m_faf_altitude_msl;
   }

   inline bool BadaPerformanceCalculator::IsFlapProgressionReversed() {
      return m_perform_reverse_flap_progression;
   }

   inline open_source::bada_utils::FlapConfiguration BadaPerformanceCalculator::PerformNormalFlapProgression(open_source::bada_utils::FlapConfiguration current_flap_configuration, Units::Speed calibrated_airspeed, const bool near_final_approach_fix) const {
      ...
      } else if (calibrated_airspeed <= m_flap_speeds.cas_gear_out_minimum &&
         near_final_approach_fix &&
         (current_flap_configuration == open_source::bada_utils::FlapConfiguration::LANDING ||
   ...
   inline open_source::bada_utils::FlapConfiguration BadaPerformanceCalculator::PerformReverseFlapProgression(open_source::bada_utils::FlapConfiguration current_flap_configuration, Units::Speed calibrated_airspeed, const bool near_final_approach_fix) const {
      // This logic uses these transition rules:
