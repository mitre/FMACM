...
namespace aaesim {
namespace avionics {
struct FmsIntegratedApplicationLoader : public LoggingLoadable {
   virtual std::string GetTopLevelTag() const = 0;
   virtual void RegisterLoadableVariables() = 0;
   virtual bool VariablesAreLoaded() const = 0;
   virtual std::shared_ptr<aaesim::avionics::FmsIntegratedApplication> ConstructLoadedAlgorithm() = 0;
   virtual bool load(DecodedStream *input) = 0;
};
}  // namespace avionics
}  // namespace aaesim
