...
namespace aaesim {
class KineticPredictionEntityIterationBuilder : public ScenarioEntityIterationBuilder {
  public:
   KineticPredictionEntityIterationBuilder(
      ...
      : m_scenario_configuration(configuration), m_kinetic_prediction_loaders(kinetic_prediction_loaders) {}
   virtual ~KineticPredictionEntityIterationBuilder() = default;
