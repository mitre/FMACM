...
namespace aaesim {
class KineticPredictionEntityWithDataCollection final : public aaesim::ScenarioEntityWithDataCollection {
  public:
   KineticPredictionEntityWithDataCollection(std::shared_ptr<aaesim::KineticPredictionEntity> delegate)
  ...
  private:
   std::shared_ptr<aaesim::KineticPredictionEntity> m_delegate;
};
}  // namespace aaesim
