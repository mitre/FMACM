...
class DriveDescent4DPredictor final : public KineticDescent4DPredictor {
  public:
   DriveDescent4DPredictor() = default;

   virtual ~DriveDescent4DPredictor() = default;
   ...
   virtual DriveDescent4DPredictor *GetDeepCopy() const;
};
