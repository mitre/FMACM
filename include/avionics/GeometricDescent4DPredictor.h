...
class GeometricDescent4DPredictor final : public KineticDescent4DPredictor {
  public:
   GeometricDescent4DPredictor() = default;

   virtual ~GeometricDescent4DPredictor() = default;
   ...
   virtual GeometricDescent4DPredictor *GetDeepCopy() const;
};
