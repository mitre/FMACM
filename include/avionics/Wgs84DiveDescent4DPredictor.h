...
class Wgs84DiveDescent4DPredictor : public Wgs84KineticDescent4DPredictor {
  public:
   Wgs84DiveDescent4DPredictor();

   virtual ~Wgs84DiveDescent4DPredictor() = default;
   ...
   virtual Wgs84DiveDescent4DPredictor *GetDeepCopy() const;
