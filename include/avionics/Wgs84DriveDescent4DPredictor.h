...
class Wgs84DriveDescent4DPredictor : public Wgs84KineticDescent4DPredictor {
  public:
   Wgs84DriveDescent4DPredictor();

   virtual ~Wgs84DriveDescent4DPredictor() = default;
   ...
   virtual Wgs84DriveDescent4DPredictor *GetDeepCopy() const;
