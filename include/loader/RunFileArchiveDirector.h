...
class RunFileArchiveDirector {
  public:
   ...
   inline std::string get_Destination() { return destination.GetFullPath(); }
   ...
   std::string get_New_Link_Name(const FilePath &source_file);  // returns the file name that should be written into the
