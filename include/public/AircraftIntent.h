...
public:
    ...
    double calcGreatCircleDist(double Lat1, double Lon1, double Lat2, double Lon2);
    double calcGreatCircleCrs(double Lat1, double Lon1, double Lat2, double Lon2, double d);
