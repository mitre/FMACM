   ...
   namespace open_source {
      class ThreeDOFDynamics {
       public:
          ...
          * @return
          */
         virtual AircraftState Update(const Guidance &guidance,
       ...
       protected:
         virtual AircraftState Integrate(const Guidance &guidance,
                                         const std::shared_ptr<AircraftControl> &aircraft_control);
         ...
         virtual EquationsOfMotionStateDeriv StatePropagation(Units::Frequency dVwx_dh,
         ...
         virtual void CalculateEnvironmentalWind(WindStack &wind_east,
